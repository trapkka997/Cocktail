			...
			<div id="grid-gallery" class="grid-gallery">
				<section class="grid-wrap">
					<ul class="grid">
						...
						<li>
							<figure>
								<img src="./resources/assets/grid/img/thumb/1.png" alt="img01"/>
								<figcaption><h3>Letterpress asymmetrical</h3><p>Chillwave hoodie ea gentrify aute sriracha consequat.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="./resources/assets/grid/img/thumb/2.png" alt="img02"/>
						...
						<li>
							<figure>
								<img src="./resources/assets/grid/img/thumb/3.png" alt="img03"/>
						...
						<li>
							<figure>
								<img src="./resources/assets/grid/img/thumb/4.png" alt="img04"/>
						...
						<li>
							<figure>
								<img src="./resources/assets/grid/img/thumb/5.png" alt="img05"/>
						...
						<li>
							<figure>
								<img src="./resources/assets/grid/img/thumb/6.png" alt="img06"/>
					...
					<ul>
						<li>
							<figure>
								...
								<img src="./resources/assets/grid/img/large/1.png" alt="img01"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="./resources/assets/grid/img/large/2.png" alt="img02"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="./resources/assets/grid/img/large/3.png" alt="img03"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="./resources/assets/grid/img/large/4.png" alt="img04"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="./resources/assets/grid/img/large/5.png" alt="img05"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="./resources/assets/grid/img/large/6.png" alt="img06"/>
							</figure>
						</li>
						<li>
							<figure>
