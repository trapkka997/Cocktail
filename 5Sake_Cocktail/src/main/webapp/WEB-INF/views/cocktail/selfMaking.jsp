...
<head>
    ...
    <link rel="stylesheet" href="./resources/assets/selfmaking/css/slidepush/proflie_slide.css?h=c31784850592eda94811485f90318815">
</head>
...
<script>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="button_container">
                        <div class="outer">
                            <div class="inner"><div id="selfMaking_button">
  ...
  <div id="alcole" class="button-group" data-filter-group='alcole' style="margin-top: 20px; margin-bottom:20px;">
    <button id ="selfMaking_tag_button1" class="btn btn-outline-primary" data-filter="*" style="margin-left: 5px; margin-right: 5px;">All
    </button>
